package demo;
		...
		act.moveToElement(ele1).click().perform();
		   ...
		   driver.findElement(By.xpath("//div[div[span[contains(text(),'Band Material')]]]/ul[7]/span[3]/li/span/a/div/label/i")).click();
		   ...
		   Thread.sleep(2500);
		   WebElement FifthEle= driver.findElement(By.xpath("//div[@cel_widget_id='MAIN-SEARCH_RESULTS-6']/div[1]/div[1]/div[2]/div[1]"));
